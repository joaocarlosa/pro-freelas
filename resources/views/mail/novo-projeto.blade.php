...
*/
    ...
    <!--[if mso
        ...
        .mso .w560 .divider {
          margin-left: unit(260px, px);
          margin-right: unit(260px, px);
        }
        .mso .w360 .divider {
        }
        .mso .w360 .divider {
          margin-left: unit(160px, px);
          margin-right: unit(160px, px);
        }
        .mso .w260 .divider {
        }
        .mso .w260 .divider {
          margin-left: unit(110px, px);
          margin-right: unit(110px, px);
        }
        .mso .w160 .divider {
        }
        .mso .w160 .divider {
          margin-left: unit(60px, px);
          margin-right: unit(60px, px);
        }
        .mso .w60 .divider {
        }
        .mso .w60 .divider {
          margin-left: unit(10px, px);
          margin-right: unit(10px, px);
        }
        .mso .w354 .divider {
        }
        .mso .w354 .divider {
          margin-left: unit(157px, px);
          margin-right: unit(157px, px);
        }
        .mso .w250 .divider {
        }
        .mso .w250 .divider {
          margin-left: unit(105px, px);
          margin-right: unit(105px, px);
        }
        .mso .w148 .divider {
        }
        .mso .w148 .divider {
          margin-left: unit(54px, px);
          margin-right: unit(54px, px);
        }
        .mso .size-8,
        .mso .size-8-m,
        .mso .size-8-l {
        ...
        .size-112-l {
          mso-text-raise: 112px;
        }
        .size-128-l {
          mso-text-raise: 128px;
        }
        .size-144-l {
          mso-text-raise: 144px;
        }
      </style><!
    [endif]-->
            ...
            <tr>
                  ...
                  ">
                    ...
                    ">
                        ...
                        ">
                            ...
                            line-height: 34px;
                          ">
                                                <center><div><p class="text-center"><a href="https://app.profreelas.com/"><img src="https://app.profreelas.com/assets/img/logo-Profreelas.png" class="rounded" style="max-width: 200px;"></a></p></div></center>
                                                <br/>
                                                <strong>Novo Projeto Publicado</strong>
                                            </h2>
                            ...
                            font-family: Avenir, sans-serif;
                          "
                                                href="{{ route('resumo', $projeto->id) }}">Acessar link do
                                                projeto</a>
                                            <br>
                                            <div class="" style="
                                            width: 100%;
                ...
                ">
                  ...
                  ">
                      ...
                      width: 100%;
                    ">
                                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-full-width" style="background-color: #ebebeb;"><td class="layout__edges">&nbsp;</td><td style="width: 600px" class="w560"><![endif]-->
                                    <div class="column"
                                        style="
                        text-align: left;
                        color: #021a2c;
                    ...
                    <div role="contentinfo">
                        <div style="line-height: 4px; font-size: 4px" id="footer-top-spacing">
                            &nbsp;
                        </div>
                ...
                "
                    ...
                    "
                        ...
                        <div style="line-height: 40px; font-size: 40px" id="footer-bottom-spacing">
                            &nbsp;
                        </div>
                    </div>
                </td>
