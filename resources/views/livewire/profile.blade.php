            ...
            <div class="card card-body border-0 shadow mb-4">
                ...
                <form wire:submit.prevent="save" action="#" method="POST">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <input wire:model="user.nome" class="form-control" id="nome"
                        ...
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <input wire:model="user.sobrenome" class="form-control" id="sobrenome"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="mb-4">
                                <label class="my-1 me-2" for="category">Habilidades</label>
                                <select name="habilidades" class="form-select" id="category" multiple
                                    aria-label="Default select example">
                    ...
                    <div class="row">
                        <div class="col-sm-12 mb-3">
                            <div class="mb-4">
                                <label class="my-1 me-2" for="category">Conte mais sobre você</label>
                                <textarea class="form-control" name="descricao" placeholder="Escreva aqui..." id="textarea" rows="8">{{ old('descricao')}}</textarea>
                            </div>
                            @error('user.address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
