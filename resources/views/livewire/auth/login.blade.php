<main>
    <title>Pro Freelas - Login</title>
    <!-- Section -->
    <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
        <div class="container">
            <p class="text-center"><a href="{{ route('dashboard') }}" class="text-gray-700"><img src="/assets/img/logo-Profreelas.png" class="rounded" style="max-width: 200px;"></a></p>
            <div wire:ignore.self class="row justify-content-center form-bg-image"
                data-background-lg="/assets/img/illustrations/signin.svg">
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            <h1 class="mb-3 h3">Bem-vindo ao Pro Freelas</h1>
                            <p class="mb-0"> Faça o login
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input wire:model="email" type="email" class="form-control"
                                        placeholder="Seu e-mail" id="email" autofocus required>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model.lazy="password" type="password" placeholder="Sua senha"
                                ...
                                <div class="d-flex justify-content-between align-items-top mb-4">
                                    ...
                                    <div><a href="{{ route('forgot-password') }}" class="small text-right">Esqueci a senha</a></div>
                                </div>
                            </div>
                            <div class="d-grid">
                        ...
                        <div class="mt-3 mb-4 text-center">
                            <span class="fw-normal">ou entre com</span>
                        </div>
                        ...
                        <div class="d-flex justify-content-center align-items-center mt-4">
                            <span class="fw-normal">
                                Não tem login?
                                <a href="https://app.profreelas.com/cadastro" class="fw-bold">Crie uma conta</a>
                            </span>
                        </div>
                    </div>
                </div>
