  ...
  <div class="sidebar-inner px-2 pt-3">
    <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
      <div class="d-flex align-items-center">
        ...
        <div class="d-block">
          <h2 class="h5 mb-3">Olá Usuário</h2>
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
        <li class="nav-item">
            <p class="text-left"><a href="/dashboard" class="text-gray-700"><img src="/assets/img/logo-Profreelas.png" class="rounded" style="max-width: 200px;"></a></p>
          </li>
      ...
      <li class="nav-item {{ in_array(Request::segment(1),['projetos','novo-projeto']) ? 'active' : '' }}">
        <a href="/projetos" class="nav-link">
          ...
          <span class="sidebar-text">Meus Projetos</span>
        </a>
      </li>
      @endif

      @if (auth()->user()->profile == 'freelancer')
      <li class="nav-item {{ Request::segment(1) == 'propostas' ? 'active' : '' }}">
        <a href="/propostas" class="nav-link">
          <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg">
              <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z"></path>
              <path fill-rule="evenodd"
          ...
          <span class="sidebar-text">{{ auth()->user()->profile == 'cliente' ? 'Propostas' : 'Minhas Propostas' }}</span>
        </a>
      </li>
      @endif
