...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4">Meus Projetos</h2>
        <p class="mb-0">Veja abaixo listagem de todos projetos</p>
    </div>
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th class="border-gray-200">Titulo</th>
        ...
        <tbody>
            ...
            @foreach ($projetos as $projeto)
                ...
                <tr>
                    ...
                    <td>
                        <span class="fw-normal">{{ $projeto->titulo }}</span>
                    </td>
                    <td><span class="fw-normal">{{ $projeto->categoria_id }}</span></td>
                    <td><span class="fw-normal">{{ $projeto->created_at }}</span></td>
                    <td><span class="fw-bold text-warning">{{ $projeto->status }}</span></td>
                    <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu py-0">
                                <a class="dropdown-item rounded-top" target="_new" href="/projeto/{{ $projeto->id }}"><span
